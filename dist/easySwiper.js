(function (global, factory) {
    ...
    easyswiper.prototype = {
        ...
        _initPage: function _initPage(index, callback) {
            ...
            var animationCb = function animationCb() {
                ...
                if (_this3.autoPlay && (_this3.current.num == _this3.numDom - 1 || _this3.current.num == 1 || _this3.current.num == 0)) {
                    _this3._resetStyle('auto');
                }
    ...
    easyswiper.prototype.gotoPage = function (newindex) {
        ...
        if (newindex < 0 || newindex > this.numDom - 1 || newindex == this.current.num || this.autoPlay) return;
